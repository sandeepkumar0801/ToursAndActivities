...
namespace Isango.Cache.Test
{
    ...
    public class ActivityCacheTest : BaseTest
    {
        ...
        public void GetActivityTest()
        {
            ...
            Assert.AreEqual("842", searchedActivity.Id);
        }
        ...
        /// </summary>
        [TestCase("27-09-2018", "Region")]
        [TestCase("28-09-2018", "Region")]
        [TestCase("27-09-2018@28-09-2018", "Region")]
        ...
        [Test]
        [Ignore("Insert activity in activity collection")]
