...
{
    public class SupplierOrHotelAddressAPI
    {
        //End supplier / Hotel Address
        ...
        public SupplierOrHotelAddressAPI(IDataReader result)
        {
            ...
            AddressWebSiteUrl = Convert.ToString(result["addresswebsiteurl"]).Trim();
        }
    }
}