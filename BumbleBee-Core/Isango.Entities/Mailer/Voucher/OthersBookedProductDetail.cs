...
{
    public class OthersBookedProductDetail
    {
        ...
        public OthersBookedProductDetail(IDataReader result)
        {
            ...
            if (result["QRString"] != DBNull.Value)
            {
                QrCode = Convert.ToString(result["QRString"]);
            }
            if (result["ApiTypeId"] != DBNull.Value)
            {
                ApiTypeId = Convert.ToString(result["ApiTypeId"]);
            }
            if (result["QRCodeType"] != DBNull.Value)
            {
                QRCodeType = Convert.ToString(result["QRCodeType"]);
            }

            if (result["IsShowSupplierVoucher"] != DBNull.Value)
            {
                IsShowSupplierVoucher = Convert.ToBoolean(result["IsShowSupplierVoucher"]);
            }

            if (result["SupplierLineNumber"] != DBNull.Value)
            {
                SupplierLineNumber = Convert.ToString(result["SupplierLineNumber"]);
            }
            if (result["IsQRCodePerPax"] != DBNull.Value)
            {
                IsQRCodePerPax = Convert.ToBoolean(result["IsQRCodePerPax"]);
            }

            if (result["SupplierName1"] != DBNull.Value)
            {
                SupplierName1 = Convert.ToString(result["SupplierName1"]);
            }
            if (result["ProviderInformation"] != DBNull.Value)
            {
                ProviderInformation = Convert.ToString(result["ProviderInformation"]);
            }
            if (result["COORDINATES"] != DBNull.Value)
            {
                Coordinates = Convert.ToString(result["COORDINATES"]);
            }
        }
    }
}