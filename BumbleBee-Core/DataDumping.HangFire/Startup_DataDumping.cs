...
using DataDumping.HangFire.Helper;
...
namespace DataDumping
{
    public class Startup_DataDumping
    {
        private readonly IConfiguration _configuration;

        public Startup_DataDumping(IConfiguration configuration)
        {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseHangfireDashboard("/isangodashboard3", options);

            DataDumpingJobs.DataDumpingJobs_Hangfire();
