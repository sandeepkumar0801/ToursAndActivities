...
{
    public class AllocSeatsAutomaticCommandHandler : CommandHandlerBase, IAllocSeatsAutomaticCommandHandler
    {
        public AllocSeatsAutomaticCommandHandler(ILogger log) : base(log)
        {
        }
        ...
        protected override object CreateInputRequest<T>(T inputContext)
        {
            ...
            rq.id_Catalog = 1;
            rq.id_CatalogDate = input.MoulinRougeContext.CatalogDateId;
            rq.listAllocRequest.ACPO_AllocSARequest.ListID_Category.Int = input.MoulinRougeContext.CategoryId;
            rq.listAllocRequest.ACPO_AllocSARequest.ListID_Contingent.Int = input.MoulinRougeContext.ContingentId;
            rq.listAllocRequest.ACPO_AllocSARequest.ListID_Bloc.Int = input.MoulinRougeContext.BlocId;
            rq.listAllocRequest.ACPO_AllocSARequest.ListID_Floor.Int = input.MoulinRougeContext.FloorId;
            rq.listAllocRequest.ACPO_AllocSARequest.ListQuantity.ACPO_AllocSARequestQuantity.ID_Rate = input.MoulinRougeContext.RateId;
            rq.listAllocRequest.ACPO_AllocSARequest.ListQuantity.ACPO_AllocSARequestQuantity.Quantity = input.MoulinRougeContext.Quantity;
