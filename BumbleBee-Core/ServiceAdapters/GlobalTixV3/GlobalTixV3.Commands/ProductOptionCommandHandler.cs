...
{
    public class ProductOptionCommandHandler : CommandHandlerBase, IProductOptionCommandHandler
    {
        #region Constructors
        public ProductOptionCommandHandler(ILogger iLog) : base(iLog)
        {
        }
        #endregion
        ...
        protected override object GetResults(object input, string authString,bool isNonThailandProduct)
        {
            ...
            AsyncClient client = GetServiceClient(Constant.URL_ProductOption);
        ...
        protected override Task<object> GetResultsAsync(object input, string authString,bool isNonThailandProduct)
        {
            ...
            var client = GetServiceClient(Constant.URL_ProductOption);
            IDictionary<string, string> queryParams = new Dictionary<string, string>();
