...
{
    public class PackageOptionsCommandHandler : CommandHandlerBase, IPackageOptionsCommandHandler
    {
        #region Constructors
        public PackageOptionsCommandHandler(ILogger iLog) : base(iLog)
        {
        }
        #endregion
        ...
        protected override object GetResults(object input, string authString, bool isNonThailandProduct)
        {
            ...
            AsyncClient client = GetServiceClient(Constant.URL_PackageOptions);
        ...
        protected override Task<object> GetResultsAsync(object input, string authString,bool isNonThailandProduct)
        {
            ...
            var client = GetServiceClient(Constant.URL_PackageOptions);
            IDictionary<string, string> queryParams = new Dictionary<string, string>();
