...
{
    public class GetAvailableTimeSlotsCommandHandler : CommandHandlerBase, IGetAvailableTimeSlotsCommandHandler
    {
        public GetAvailableTimeSlotsCommandHandler(ILogger log) : base(log)
        {
        }
        ...
        {
            return $"{UriConstant.Products}{availabilityCriteria.ProductId}{UriConstant.AvailableTimeSlots}{availabilityCriteria.Language}{UriConstant.Day}{availabilityCriteria.CheckinDate:yyyy-MM-dd}";
        }
    }
}