...
{
    public class GetAvailabilityByIdCommandHandler : CommandHandlerBase, IGetAvailabilityByIdCommandHandler
    {
        public GetAvailabilityByIdCommandHandler(ILogger log) : base(log)
        {
        }
        ...
        {
            return $"{UriConstant.Products}{availabilityCriteria.ProductId}{UriConstant.CheckoutInformation}{availabilityCriteria.Language}";
        }
    }
}