...
{
    public class GetProductDatesCommandHandler : CommandHandlerBase, IGetProductDatesCommandHandler
    {
        public GetProductDatesCommandHandler(ILogger log) : base(log)
        {
        }

        /// <summary>
        /// Call to get the product dates
        /// </summary>
        ...
        /// <summary>
        /// Call to get the product dates asynchronously
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="inputContext"></param>
        /// <returns></returns>
        ...
        private string GenerateMethodPath(GoldenToursCriteria criteria)
        {
            ...
            return $"{_baseAddress}{string.Format(UriConstants.GetProductDates, criteria?.SupplierOptionCode, _key, criteria?.Status, checkInDate, checkoutDate)}";
        }
