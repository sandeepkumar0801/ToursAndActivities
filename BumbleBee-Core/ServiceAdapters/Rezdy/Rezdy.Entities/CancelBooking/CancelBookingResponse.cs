...
namespace ServiceAdapters.Rezdy.Rezdy.Entities.CancelBooking
{
    public class CancelBookingResponse
    {
        ...
        public CancelBooking Booking { get; set; }

        [JsonProperty("requestStatus")]
        public CancelBookingRequestStatus RequestStatus { get; set; }
    }
    ...
    public class CancelBooking
    {
        ...
        public CancelBookingCreditCard CreditCard { get; set; }

        [JsonProperty("customer")]
        public CancelBookingCustomer Customer { get; set; }
        ...
        [JsonProperty("fields")]
        public CancelBookingField[] Fields { get; set; }

        [JsonProperty("internalNotes")]
        public string InternalNotes { get; set; }

        [JsonProperty("items")]
        public CancelBookingItem[] Items { get; set; }
        ...
        public CancelBookingPayment[] Payments { get; set; }
    ...
    public class CancelBookingCreditCard
    {
    ...
    public class CancelBookingCustomer
    {
    ...
    public class CancelBookingField
    {
    ...
    public class CancelBookingItem
    {
        ...
        [JsonProperty("extras")]
        public CancelBookingExtra[] Extras { get; set; }

        [JsonProperty("participants")]
        public CancelBookingParticipant[] Participants { get; set; }
        ...
        public CancelBookingQuantity[] Quantities { get; set; }
        ...
        [JsonProperty("vouchers")]
        public CancelBookingVoucher[] Vouchers { get; set; }
    }

    public class CancelBookingExtra
    {
        ...
        [JsonProperty("image")]
        public CancelBookingImage Image { get; set; }
    ...
    public class CancelBookingImage
    {
        [JsonProperty("id")]
        public string Id { get; set; }
    ...
    public class CancelBookingParticipant
    {
        [JsonProperty("fields")]
        public CancelBookingField[] Fields { get; set; }
    }
    ...
    public class CancelBookingQuantity
    {
    ...
    public partial class CancelBookingVoucher
    {
        [JsonProperty("code")]
        public string Code { get; set; }
    ...
    public class CancelBookingPayment
    {
        [JsonProperty("amount")]
        public string Amount { get; set; }
    ...
    public class CancelBookingRequestStatus
    {
        [JsonProperty("error")]
        public CancelBookingError Error { get; set; }
        ...
        public CancelBookingWarning Warning { get; set; }
    }

    public class CancelBookingError
    {
    ...
    public class CancelBookingWarning
    {
