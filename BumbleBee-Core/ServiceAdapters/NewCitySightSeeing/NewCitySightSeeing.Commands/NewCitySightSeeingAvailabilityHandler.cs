...
{
    public class NewCitySightSeeingAvailabilityHandler : CommandHandlerBase, INewCitySightSeeingAvailabilityHandler
    {
        public NewCitySightSeeingAvailabilityHandler(ILogger iLog) : base(iLog)
        {
        }
