...
{
    public class ChannelCommandHandler : CommandHandlerBase, IChannelCommandHandler
    {
        public ChannelCommandHandler(ILogger log) : base(log)
        {
        }
        ...
        {
            return $"{UriConstant.Products}{UriConstant.Channels}{UriConstant.Lists}";
        }
