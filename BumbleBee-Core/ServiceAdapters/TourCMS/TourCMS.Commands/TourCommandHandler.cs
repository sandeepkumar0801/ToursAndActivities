...
{
    public class TourCommandHandler : CommandHandlerBase, ITourCommandHandler
    {
        public TourCommandHandler(ILogger log) : base(log)
        {
        }
        ...
        {
            return $"{UriConstant.Products}{UriConstant.Tours}{UriConstant.Lists}";
        }
