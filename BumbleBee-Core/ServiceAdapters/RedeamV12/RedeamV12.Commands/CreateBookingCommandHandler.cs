...
namespace ServiceAdapters.RedeamV12.RedeamV12.Commands
{
    ...
    {
        private RedeamV12APIConfig redeamAPIConfig;

        public CreateBookingCommandHandler(ILogger log) : base(log)
        {
            redeamAPIConfig = RedeamV12APIConfig.GetInstance();
        }
        ...
        private List<Item> PrepareItems(CanocalizationSelectedProduct redeamSelectedProduct)
        {
            ...
            {
                parseData = productOption.TravelInfo.StartDate.ToString(outputFormat);
            }
