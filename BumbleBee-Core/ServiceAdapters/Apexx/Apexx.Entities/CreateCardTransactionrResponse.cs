...
{
    public class CreateCardTranasactionResponse
    {
        ...
        public CardCreateCardTransaction Card { get; set; }
        ...
        public ThreeDsCreateCardTransaction ThreeDS { get; set; }
    ...
    public class CardCreateCardTransaction
    {
    ...
    public class ThreeDsCreateCardTransaction
    {
